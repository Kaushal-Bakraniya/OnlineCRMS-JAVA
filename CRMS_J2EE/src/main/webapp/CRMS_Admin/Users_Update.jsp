...
<title>Users Update - CRMS Admin</title>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-6  mt-3 mb-4">
							<h2>Edit & Delete Users Details</h2>
						</div>
					...
					<table class="table">
						...
						<tbody id="tbl">
							...
							<tr id="myTr">
								...
								<td><a
									href="Users_UpdateForm.jsp?ID=<%=res.getInt(1)%>&OP=edit">Edit</a></td>
								<td><a
									href="Users_UpdateForm.jsp?ID=<%=res.getInt(1)%>&OP=delete">Delete</a></td>
							</tr>
							<%
							}
							%>
