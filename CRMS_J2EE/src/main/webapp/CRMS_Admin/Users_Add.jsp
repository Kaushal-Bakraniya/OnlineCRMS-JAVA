...
<title>Add Users - CRMS Admin</title>
										...
										<form action="../userController_Admin" method="post"
											...
											<div class="row mb-2">
												<div class="col-sm-12 text-dark">
													<h2 class="font-weight-bold ml-1 pb-1">Add New User</h2>
												</div>
											</div>
											<div class="row mb-2">
												<div class="col-sm-3">
											...
											<div class="row mb-2">
												...
												<div class="col-sm-9 text-secondary">
													<input type="text" class="form-control" name="txtContact"
														placeholder="10 Digits Only" value="">
												</div>
											</div>
											<div class="row mb-2">
												<div class="col-sm-3">
											...
											<div class="row mb-2">
												...
												<div class="col-sm-9 text-secondary">
													<select name="city" class="form-control">
														...
														String a_city = "";
														a_city += (String)request.getSession().getAttribute("access");
											...
											<div class="row mb-0">
												<div class="col-sm-3">
													<h6 class="mt-3">Profile Picture</h6>
												</div>
												<div class="col-sm-9 text-secondary">
