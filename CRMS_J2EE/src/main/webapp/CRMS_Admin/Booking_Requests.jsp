...
<title>Booking Requests - CRMS Admin</title>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-6  mt-3 mb-4">
							<h2 class="text-secondary ml-2">Booking Requests</h2>
						</div>
				...
				<div class="container-fluid">
					...
					<div class="table-responsive" style="width: 97%">
						<table class="table">
							...
							<tbody id="tbl">
								<%
								String selectQuery = "select * from tbl_rented where Status != 'Rented' and Status != 'Canceled'";
