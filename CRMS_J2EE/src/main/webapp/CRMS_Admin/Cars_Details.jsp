				...
				<div class="container">
					<div class="row">
						<div class="col-lg-5  mt-3 mb-4">
							<h2 class="text-secondary ml-2">Car Details</h2>
						</div>
						<div class="col-lg-7 mt-3 mb-4 text-right">
					...
					<table class="table">
						...
						<tbody id="tbl">
							...
							<tr id="myTr">
								...
								<td><a
									href="Cars_ViewDetails.jsp?RegNo=<%=res.getString(2)%>">View
										Details</a></td>
							</tr>
							<%
							}
